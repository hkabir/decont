<div class="row">
	<div class="col-xs-12 col-sm-6">
		<div class="form-group">
			<?php echo $this->Form->control('name', ['label' => 'Nume client', 'class' => 'form-control']); ?>
		</div>
	...
	<div class="col-xs-12 col-sm-6">
		...
		<div class="form-group">
			<?php echo $this->Form->control('user_id', ['options' => $users], ['label' => 'Reg Comertului', 'class' => 'form-control']); ?>
		</div>
	</div>
